...
translate([0,0,-5])opener();

color("black")linear_extrude(2)translate([11,-13,0])scale(1.2)rotate([0,0,90])import("/home/goldishlaser/usb-a-magnetic-breakaway/digitalAssets/logo/2021_vector/buskill_wordsonly.svg");
